    ...
    return (
      <section className="all-section">
        ...
        <div>
          ...
          <button onClick={() => this.searchGenre("Card Game")}>
            Card Game
          </button>
          ...
          <button onClick={() => this.searchPlatform("Web Browser")}>
            Web Browser
          </button>
          <button onClick={() => this.searchPlatform("PC (Windows)")}>
            PC (Windows)
          </button>
          <h2
            style={{
          ...
          >
            <button onClick={() => this.removePlatform()}>X</button>
          ...
          >
            <button onClick={() => this.removeGenre()}>X</button>
